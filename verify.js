...
console.log('EXPRESSIONS:', D.EXPRESSIONS.length, '(expect 25)');
...
Object.entries(D.POOLS).forEach(([k, p]) => p.forEach(idx => { if (idx < 0 || idx >= 25) { ok = false; console.log('bad pool idx', k, idx); } }));
